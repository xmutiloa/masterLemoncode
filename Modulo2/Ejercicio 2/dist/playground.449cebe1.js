...
var colors1 = ["Yellow", "Red", "Blue", "Green"];
var colors2 = ["Black", "White", "Brown", "Grey"];

var concat = function concat(a, b) {
  return [].concat(_toConsumableArray(a), _toConsumableArray(b));
};

console.log("Concat: " + concat(colors1, colors2)); // Opcional

var colors3 = ["Pink", "Olive", "Marine", "Purple"];

var concatMulti = function concatMulti() {
  var result = [];
  ...
  for (var _i = 0, _arrays = arrays; _i < _arrays.length; _i++) {
    ...
    result = [].concat(_toConsumableArray(result), _toConsumableArray(array));
  }
...
},{}]},{},["../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","playground.js"], null)
