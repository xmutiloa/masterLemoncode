...
console.log("Head: " + head(colors1)); //--------INIT-------
...
var colors2 = ["Yellow", "Red", "Blue", "Green"];
...
console.log("Init: " + init(colors2)); //--------TAIL-------
...
var colors3 = ["Yellow", "Red", "Blue", "Green"];

var tail = function tail(_ref5) {
